...
namespace OnlineSatis.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            model.kategoriler = db.Kategori.ToList();//Slider <= ? bu mu hayır orası kategori
        ...
        [HttpPost]
        public ActionResult urunAra(string aramaMetni)
        {
            var urunler = db.Urun.Where(u => u.Adi.Contains(aramaMetni) || u.Aciklama.Contains(aramaMetni)).ToList();
