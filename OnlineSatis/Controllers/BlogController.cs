...
namespace KurumsalWeb.Controllers
{
    public class BlogController : Controller
    {
        ...
        {
            ViewBag.BlogKategoriId = new SelectList(db.BlogKategori, "BlogKategoriId", "KategoriAd");
            return View();
        }
        [HttpPost]
        [ValidateInput(false)]
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewBag.KategoriId = new SelectList(db.BlogKategori, "BlogKategoriId", "KategoriAd", b.BlogKategoriId);
            return View(b);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
