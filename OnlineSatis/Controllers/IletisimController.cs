...
namespace OnlineSatis.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Facebook,Twitter,Instagram,Youtube")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Facebook,Twitter,Instagram,Youtube")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
